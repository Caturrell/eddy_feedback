...
def compute_anomalies(ds_model, season, months, vertical_average=False):
    ...
    var_anoms = var_anoms.sel(lat=slice(-90,-20), level=500).rename({'ens_ax': 'time'})
...
save_data_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/lat_20_90/data/pamip_SAM_U500'
os.makedirs(save_data_path, exist_ok=True)
plot_base_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/lat_20_90/plots/pamip_eof1s_SAM_U500'
