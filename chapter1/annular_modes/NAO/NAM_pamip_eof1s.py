...
def compute_anomalies(ds_model, season, months, vertical_average=False):
    ...
    var_anoms = var_anoms.sel(lat=slice(0,90), level=500).rename({'ens_ax': 'time'})
...
save_data_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/NAO/data/pamip_NAM'
os.makedirs(save_data_path, exist_ok=True)
plot_base_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/NAO/plots/pamip_eof1s_NAM'
...
for season, months in seasons.items():
    ...
    data_save_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/NAO/data/pamip_misc'
