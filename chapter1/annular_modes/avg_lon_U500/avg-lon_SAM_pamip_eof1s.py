...
def compute_anomalies(ds_model, season, months, vertical_average=False):
    ...
    var_anoms = var_anoms.mean('lon').sel(lat=slice(-90,0), level=500).rename({'ens_ax': 'time'})
...
save_data_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_lon_U500/data/pamip_SAM_U500'
os.makedirs(save_data_path, exist_ok=True)
plot_base_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_lon_U500/plots/pamip_eof1s_SAM_U500'
...
for season, months in seasons.items():
    ...
    data_save_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_lon_U500/data/pamip_misc'
