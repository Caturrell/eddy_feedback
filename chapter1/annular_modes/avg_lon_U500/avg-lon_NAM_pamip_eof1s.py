...
def eof_calc_alt(data, lats):
    ...
    wgts = np.sqrt(coslat)[np.newaxis, :] # colon for latitude variable
...
def compute_anomalies(ds_model, season, months, vertical_average=False):
    ...
    var_anoms = var_anoms.mean('lon').sel(lat=slice(0,90), level=500).rename({'ens_ax': 'time'})
...
save_data_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_mon_U500/data/pamip_NAM'
os.makedirs(save_data_path, exist_ok=True)
plot_base_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_mon_U500/plots/pamip_eof1s_NAM'
...
for season, months in seasons.items():
    ...
    # fig.suptitle(f"EOF 1 of U500 ({season})", fontsize=14)
    ...
    data_save_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/avg_mon_U500/data/pamip_misc'
