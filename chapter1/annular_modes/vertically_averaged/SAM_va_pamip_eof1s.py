...
def compute_anomalies(ds_model, season, months, vertical_average=True):
    ...
    var_anoms = var_anoms.sel(lat=slice(-90,0), level=slice(1000,100)).rename({'ens_ax': 'time'})
...
save_data_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/vertically_averaged/data/sh/pamip_SAM'
os.makedirs(save_data_path, exist_ok=True)
plot_base_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/vertically_averaged/plots/sh/pamip_eof1s_SAM'
...
for season, months in seasons.items():
    ...
    data_save_path = '/home/links/ct715/eddy_feedback/chapter1/annular_modes/vertically_averaged/data/sh/pamip_misc'
