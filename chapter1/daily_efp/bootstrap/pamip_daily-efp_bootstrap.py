...
def process_model_bootstrap(model, ds, season, sample_size, output_base, is_southern=False):
    ...
    save_path = os.path.join(output_base, f'{model}_{season}_efp_values.npy')
...
def main():
    ...
    path_dir = '/home/links/ct715/data_storage/PAMIP/processed_daily/daily-efp_mon_u_divFy_psl'
    output_base = '/home/links/ct715/eddy_feedback/chapter1/daily_efp/bootstrap/data'
