...
python /home/links/ct715/eddy_feedback/chapter1/resolution/isca/isca_scripts/hs_land_T21-T42-T63-T85.py
...
resolution_experiments = ['T21', 'T42', 'T63', 'T85']

for res in resolution_experiments:
    ...
    RESOLUTION = res, 40  # (horizontal resolution, levels in pressure)
    ...
    exp_name = f'HS_{RESOLUTION[0]}-land_{YEARS}y'
    exp = Experiment(exp_name, codebase=cb)

    exp.inputfiles = [os.path.join(GFDL_BASE,f'input/land_masks/land_{res}.nc')]
    ...
    namelist = Namelist({
        ...
        'spectral_init_cond_nml':{
             'topog_file_name': f'land_{res}.nc', #Name of land input file, which will also contain topography if generated using Isca's `land_file_generator_fn.py' routine.
