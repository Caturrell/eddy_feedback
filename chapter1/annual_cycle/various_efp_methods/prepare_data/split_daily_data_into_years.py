...
def split_netcdf_by_year(input_path, output_dir=None, time_dim='time'):
    ...
    for year, ds_year in ds.groupby('year'):
        ...
        if output_dir:
            ...
            output_path = os.path.join(output_dir, f"{year}_daily_uvtw.nc")
...
if __name__ == "__main__":
    ...
    input_file = os.path.join(path, "jra55_uvtw.nc")      # <-- replace with your file
    output_folder = os.path.join(path, "split_years_1958-2016", 'daily_uvtw')   # <-- or set to None if you don’t want to save
