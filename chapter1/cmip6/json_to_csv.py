...
base_dir = '/home/links/ct715/eddy_feedback/chapter1/cmip6/data'
...
for model_dir in os.listdir(base_dir):
    ...
    json_files = [f for f in os.listdir(model_path) if f.endswith('_efp_results_CMIP6_piControl.json')]
    if not json_files:
...
csv_path = os.path.join(base_dir, "cmip6_efp_winters.csv")
