...
def main():
    ...
    daily_path = '/gws/nopw/j04/arctic_connect/cturrell/CMIP6/piControl/efp_data_sit/30y/daily_averages'
    ...
    fig1 = plot_all_models(datasets_monthly, models_other_list, 
                           'Models with EFP = 1.0 (Monthly Averaged)', variables=vars_to_plot)
    plt.savefig(f'{save_plot_path}/working_models_monthly_{vars_to_plot[0]}_{vars_to_plot[1]}.png', dpi=300, bbox_inches='tight')
    plt.close(fig1)
    
    fig2 = plot_all_models(datasets_monthly, models_1_0, 
                           'Working Models (Monthly Averaged)', variables=vars_to_plot)
    plt.savefig(f'{save_plot_path}/efp_1.0_monthly_{vars_to_plot[0]}_{vars_to_plot[1]}.png', dpi=300, bbox_inches='tight')
    plt.close(fig2)
    ...
    fig3 = plot_all_models_batch(
        ...
        save_path=f'{save_plot_path}/efp_1.0_daily_{vars_to_plot[0]}_{vars_to_plot[1]}.png',
    ...
    fig4 = plot_all_models_batch(
        ...
        save_path=f'{save_plot_path}/efp_other_daily_{vars_to_plot[0]}_{vars_to_plot[1]}.png',
        variables=vars_to_plot
    )
    plt.close(fig4)
