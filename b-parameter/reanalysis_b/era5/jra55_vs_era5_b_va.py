...
METHOD_INFO = [
    ('JRA55 (250–500–850 hPa)', '-',  'jra55'),
    ('ERA5 (250–500–850 hPa)',  '--', 'era5'),
]
...
def plot_b_method_comparison_single_hem(b_datasets, use_va, hemisphere):
    ...
    fig.suptitle(
        f'b-parameter annual cycle (250–500–850 hPa) — JRA55 vs ERA5 — {hem_label}'
...
# ── main ─────────────────────────────────────────────────────────────────────
b_datasets = {
    'jra55': xr.open_dataset(b_path_jra55),
    'era5':  xr.open_dataset(b_path_era5),
}
