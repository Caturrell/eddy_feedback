...
methods used throughout this directory's z_fig* scripts:
    ...
    variant:             va (vertically-averaged) vs native (non-averaged)

Southern Hemisphere, DJF, div1_QG (all wavenumbers) only.
...
out_file = os.path.join(data_dir, 'tau_b_level-va-native_jra55_DJF.csv')
