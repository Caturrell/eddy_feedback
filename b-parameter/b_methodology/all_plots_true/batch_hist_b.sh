...
#SBATCH --output=alltrue_hist_processing.out  # Standard output file
#SBATCH --error=alltrue_hist_processing.err  # Standard error file
...
python /home/users/cturrell/documents/eddy_feedback/b-parameter/b_methodology/all_plots_true/hist_calc_efp_b.py