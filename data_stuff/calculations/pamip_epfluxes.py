...
if __name__ == '__main__':
    ...
    ta_files = glob.glob('/gws/nopw/j04/arctic_connect/cturrell/PAMIP_data/ \
                         regridded/CNRM-CM6-1_3x3/ta/*')
    ua_files = glob.glob('/gws/nopw/j04/arctic_connect/cturrell/PAMIP_data/ \
                         regridded/CNRM-CM6-1_3x3/ua/*')
    va_files = glob.glob('/gws/nopw/j04/arctic_connect/cturrell/PAMIP_data/ \
                         regridded/CNRM-CM6-1_3x3/va/*')
    ...
    for i, file in enumerate(ta_files):
        ...
        # Save new dataset
        dataset.to_netcdf(f'/gws/nopw/j04/arctic_connect/cturrell/PAMIP_data/regridded/ \
